...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch() async {
    ...
    try {
      // Search in local Tunisian recipes
      final results = await TunisianRecipesService.searchRecipes(query);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(languageProvider.translate('search_recipes'))),
      body: Column(
        children: [
          // Barre de recherche
          Padding(
